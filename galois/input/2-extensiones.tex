...
\begin{thm}[Transitividad de grados]\label{thm:transgr} % 2.1
...
\begin{thm}[Extensiones finitas y algebraicas]\label{thm:finitaalgebraica} %2.2
...
\begin{thm}[Teorema del elemento algebraico]\label{thm:elemalg} %2.3
...
\begin{thm}[Extensión por varios elementos algebraicos]\label{thm:extalg} %2.4
...
\begin{thm}[Extensión de un isomorfismo de cuerpos] % 2.5
